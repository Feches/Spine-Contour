...
try {
  ...
  // (2026-09-12) and the record id appears nowhere in the file; the film date, the note, the ten
  ...
  check('the first row (post-op/S001, by name then store order) reads its name, view, subject and timepoint, with empty numbers and no record id',
    exported[4] === `S001,Standing lateral,S001,Post-op${emptyCells}` && !exported[4].includes(idOf('post-op/S001.png')), exported[4]);
