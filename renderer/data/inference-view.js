...
export function inferenceView(view) {
  ...
  if (normaliseView(label) || ['lateral', 'lumbar lateral', 'lateral lumbar', 'cervical lateral', 'lateral cervical', 'full spine lateral', 'lateral full spine'].includes(label)) return 'lateral';
  return null;
}
